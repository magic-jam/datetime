...
class Date
{
    ...
    public static function defaultTimezone() {
        if (self::$defaultTimezone === null) {
            self::$defaultTimezone = new DateTimeZone(date_defaultTimezone_get());
        }
    ...
    public static function parseDateTime($value) {
        if ($value === null) {
            return null;
        } elseif ($value instanceof \mj\DateTime) {
            return $value;
        } elseif ($value instanceof \mj\Date) {
    ...
    public function __sleep() {
        return array('y', 'm', 'd', 'h', 'i', 's', 'timezoneName');
    }
    
    public function __wakeup() {
        $this->set_timezone($this->timezoneName);
        $this->generateNative();
    }
